...
// NewEncrypter NewCFB8Encrypter returns a Stream which encrypts with cipher feedback mode
...
// NewDecrypter NewCFB8Decrypter returns a Stream which decrypts with cipher feedback mode
// (segment size = 8), using the given Block. The iv must be the same length as
// the Block's block size.
